...
\begin{document}
	...
	\section{Umfrage}
		...
		\subsection{Inhalt der Umfrage}
			Die Erhebung wird in vier Teile gegliedert, die im Folgenden näher erläutert sind: 
			...
			\paragraph{Demografische Differenzen}
				Zur Analyse von Differenzen innerhalb der Bevölkerungen wird die Umfrage Fragen zur aktuellen Tätigkeit\footnote{Schüler, Student, Arbeitnehmer, etc.}, dem Geschlecht sowie zur Selbsteinschätzung der Computerkenntnisse enthalten.
