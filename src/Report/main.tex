...
\begin{document}
        ...
        \subsection{Demographische Differenzen}
            ...
            \subsubsection{Selbsteinschätzung}
                ...
                \paragraph{Signifikanz}
                    ...
                    % TODO Sollen das sub-paragraphs sein?
                    \subparagraph{Beschreibung der Tabelle}
    ...
    \section{Zusammenfassung}
        ...
        \subsection{Fazit}
            \begin{itemize}
                \item Grundwissen ist vorhanden - proportional zu (selbst angegebenen) Kenntnisstand
                \item Nutzer projizieren ihre Sicht auf Unternehmen
                \item In einigen Bereichen (z.B. OpSys) ist zu vermuten, dass Vorzeigebeispiele wie Linux zu einem höheren Kenntnisstand bzgl. \gls{oss} führen. In anderen Bereichen (z.B. Browser) ist dies genau gegenteilig und große Konzerne verleiten die Nutzer zu falschem Wissen. 
            \end{itemize}
