...
\begin{document}
    ...
    \section{Ergebnisse}
        \subsection{Wissen über OSS}
            ...
            Um dies zu ermitteln, wurde im Abschnitt \emph{Nutzungsverhalten} sowohl gefragt, welche Softwares aus einer vorgegebenen Liste genutzt wird als auch welche \gls{oss} sind oder nutzen. Die Daten wurden mit Hilfe von Abbildung \ref{figure:knowledge_difference} ausgewertet.
